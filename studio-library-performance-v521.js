...
(function () {
    ...
    function init() {
        ...
        window.AuraLibraryPerformanceV521 = {
            get legacyAlias() { return window.AuraLibraryPerformanceV52; },
            version: VERSION,
            open: openLibrary,
            close: closeLibrary,
        ...
        window.AuraLibraryPerformanceV52 = window.AuraLibraryPerformanceV521;

        console.info(
            "[Vide Aura Library Performance V5.2.1] Inicializado",
            {
