(function iniciarNavegacaoVideHub() {
    ...
    function iniciar() {
        ...
        function obterNomeBotao(botao) {
            const rotulo = botao.querySelector(".vide-dock-label");
        ...
        function envolverRotuloBotao(botao) {
            if (botao.querySelector(".vide-dock-label")) return;
            ...
            const spanComTexto = spans.find(function(span) {
                return span.textContent.trim() !== "" && !span.querySelector("svg");
            });

            if (spanComTexto) {
                spanComTexto.classList.add("vide-dock-label");
                return;
            }
            ...
            const texto = textos.map(function(no) {
