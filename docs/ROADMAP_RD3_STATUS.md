...
2. Testes de UI automatizados cobrindo login real (autenticação de verdade, não dado sintético injetado no DOM) continuam pendentes em todos os módulos — limitação conhecida e registrada desde `docs/CENTRAL_ATENDIMENTO.md`.
